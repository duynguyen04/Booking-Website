...
const InfoBoard = () => {
  ...
  useEffect(() => {
    if (username) {
      fetch("http://localhost:5000/lastest-transaction")
        .then((res) => res.json())
        .then((data) => {
          setlastestList(data);
        });
  ...
  return (
    <Dashboard>
      <div>
        <div className="info">
          <div className="title">
            <p className="title-info">USERS</p>
            <p className="title-count">{countUser}</p>
          ...
          <div className="title">
            <p className="title-info">ORDERS</p>
            <p className="title-count">{countOrder}</p>
          ...
          <div className="title">
            <p className="title-info">EARNINGS</p>
          ...
          <div className="title">
            <p className="title-info">BALANCE</p>
            <p className="title-count">0</p>
